...
data class Company(@PrimaryKey(autoGenerate = true) var id: Int = 0,
              ...
              var registertIFrivillighetsregisteret: Boolean? = null,
              var registrertIMvaregisteret: Boolean? = null,
              var registrertIForetaksregisteret: Boolean? = null,
              var registrertIStiftelsesregisteret: Boolean? = null,
              var antallAnsatte: Int? = null,
              var sisteInnsendteAarsregnskap: Int? = null,
              var konkurs: Boolean? = null,
              var underAvvikling: Boolean? = null,
              var underTvangsavviklingEllerTvangsopplosning: Boolean? = null,
